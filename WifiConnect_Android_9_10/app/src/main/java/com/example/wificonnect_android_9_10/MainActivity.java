...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * 1：连接成功？ 2 正在连接（如果wifi热点列表发生变需要该字段）
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!WifiSupport.isOpenWifi(MainActivity.this)){
           if(!WifiSupport.openWifi(MainActivity.this)){
               //android Q 无法使用WifiManager 打开wifi 通过 打开wifi面板用户手动打开
               Toast.makeText(MainActivity.this,"WIFI处于关闭状态 打开wifi 获取wifi信息",Toast.LENGTH_SHORT).show();
    ...
    public class WifiBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if(WifiManager.WIFI_STATE_CHANGED_ACTION.equals(intent.getAction())){
                ...
                Log.d(TAG,"网络列表变化了：" + realWifiList.toString());
                wifiListChange();
            }
        }
    }
